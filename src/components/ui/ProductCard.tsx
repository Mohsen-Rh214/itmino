    ...
    <div className="bg-white border border-gray-200 rounded-lg overflow-hidden shadow-sm hover:shadow-xl transition-shadow duration-300 ease-in-out group relative">
      ...
      <div className="p-4 flex flex-col">
        ...
        <div className="flex items-center justify-between mt-auto">
            ...
            <button className="bg-brand text-white p-2 rounded-full hover:bg-brand-dark focus:outline-none focus:ring-2 focus:ring-brand focus:ring-opacity-50 transition-all duration-300 hover:shadow-lg hover:shadow-brand/40" aria-label={`افزودن ${name} به سبد خرید`}>
